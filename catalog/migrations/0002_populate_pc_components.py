...
def populate_pc_components(apps, schema_editor):
    ...
    products_data = [
        ...
        # Case (Aggiunto per configuratore)
        {
            "name": "Corsair 4000D Airflow Black",
            "description": "Case ATX Mid-Tower con pannello frontale ottimizzato per un elevato flusso d'aria. Interni spaziosi, gestione cavi semplificata e due ventole da 120mm incluse.",
            "price": 99.90,
            "stock": 20,
            "category": "Case"
        }
